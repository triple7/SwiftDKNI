...
extension CMEGeometryBuilder {
    ...
    public func buildAcceleratedEnergyTunnels(
            ...
            do {
                ...
                material.setValue(NSNumber(value: config.tunnelRadiusBase), forKey: "u_tunnelRadiusBase")
                material.setValue(NSNumber(value: config.particleBaseSize), forKey: "u_particleBaseSize")
                material.setValue(NSNumber(value: config.particleVariance), forKey: "u_particleVariance")
                
                material.setValue(NSNumber(value: config.warpIntensity), forKey: "u_warpIntensity")
                material.setValue(NSNumber(value: config.boilSpeed), forKey: "u_boilSpeed")
                material.setValue(NSNumber(value: config.twinkleSpeed), forKey: "u_twinkleSpeed")
                ...
                // --- NEW: Apex Turbulence Uniforms ---
                material.setValue(NSNumber(value: config.turbulenceFrequency), forKey: "u_turbulenceFrequency")
                material.setValue(NSNumber(value: config.turbulenceAmplitude), forKey: "u_turbulenceAmplitude")
                material.setValue(NSNumber(value: config.apexWarpMultiplier), forKey: "u_apexWarpMultiplier")
                material.setValue(NSNumber(value: config.apexSoftness), forKey: "u_apexSoftness")
